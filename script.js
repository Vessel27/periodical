    ...
    function showDetails(el) {
        ...
        modalBody.innerHTML = `
            ...
            <div class="info-grid">
                ...
                <div class="info-item"><span class="info-label">Atomic Mass:</span> ${el.atomic_mass}</div>
                <div class="info-item"><span class="info-label">Category:</span> ${el.category}</div>
                <div class="info-item"><span class="info-label">Phase:</span> ${el.phase}</div>
                <div class="info-item"><span class="info-label">Boiling Point:</span> ${el.boil || 'N/A'} K</div>
                <div class="info-item"><span class="info-label">Melting Point:</span> ${el.melt || 'N/A'} K</div>
